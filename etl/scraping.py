...
class whisky_web_scraping():
    ...
    def get_product_price(self, proudcts_info_price):
        ...
        Parameteres
        -----------
        proudcts_info_content : str
                                The div object of class product-card__data.
    ...
    def scrape_whisky(self, url = 'https://www.thewhiskyexchange.com', number_of_pages = 1):
        '''
        ...
        for link in links:
            ...
            # Export data for each whiskey type to a seperate CSV file
                ...
                data.to_csv(f"{OUTPUT_DIR}/{link[start_location:end_location]}" + '.csv')
...
if __name__ == '__main__':
    ...
    data = scraper.scrape_whisky(number_of_pages=1)